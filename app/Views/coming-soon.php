...
<body>
    <div class="soon">
                ...
                <div class="col-md-9 col-lg-8">
                    <div class="soon-content text-center">
                        <div class="soon-content-wrapper">
                            <img src="<?=BASE_PATH?>/public/images/logo-icon.png" alt="Logo" class="soon-logo mx-auto">
        ...
        <div class="soon-bg bg-image" style="background-image: url(<?=BASE_PATH?>/public/images/backgrounds/soon-bg.jpg)"></div>
