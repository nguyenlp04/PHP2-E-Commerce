                	...
                	<div class="entry-container max-col-4" data-layout="fitRows">
                        <div class="entry-item lifestyle shopping col-sm-6 col-md-4 col-lg-3">
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-1.jpg" alt="image desc">
                                    </a>
                        ...
                        <div class="entry-item lifestyle col-sm-6 col-md-4 col-lg-3">
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media entry-video">
                                    <a href="single.html">
                                        <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-2.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                            ...
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl">
                                        <a href="single.html">
                                            <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-3.jpg" alt="image desc">
                                        </a>
                                        <a href="single.html">
                                            <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-4.jpg" alt="image desc">
                                        </a>
                        ...
                        <div class="entry-item travel hobbies col-sm-6 col-md-4 col-lg-3">
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-5.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                        ...
                        <div class="entry-item hobbies col-sm-6 col-md-4 col-lg-3">
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-6.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
                        ...
                        <div class="entry-item travel col-sm-6 col-md-4 col-lg-3">
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <div class="owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl">
                                        <a href="single.html">
                                            <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-7.jpg" alt="image desc">
                                        </a>
                                        <a href="single.html">
                                            <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-6.jpg" alt="image desc">
                                        </a>
                        ...
                        <div class="entry-item fashion col-sm-6 col-md-4 col-lg-3">
                            <article class="entry entry-grid text-center">
                                <figure class="entry-media">
                                    <a href="single.html">
                                        <img src="<?=BASE_PATH?>/public/images/blog/grid/4cols/post-8.jpg" alt="image desc">
                                    </a>
                                </figure><!-- End .entry-media -->
